...
export const TelegramSVG = ({ color = "#94b5bc", className }: SVGProps) => {
  return (
    ...
    >
      <g fill={color}>
        <path d="M8 0h2v1H8zM6 1h2v1H6zM9 1h1v1H9zM4 2h2v1H4zM8 2h1v3H8zM2 3h2v1H2zM0 4h2v1H0zM5 4h1v1H5zM0 5h1v1H0zM4 5h1v1H4zM7 5h1v3H7zM1 6h1v1H1zM3 6h1v3H3z" />
        <path d="M2 7h2v2H2zM4 8h1v1H4zM6 8h1v2H6z" />
        <path d="M5 9h2v1H5z" />
      </g>
    </svg>
  );
...
/* OTHER ICONS */
export const CopySVG = ({ color = "#94b5bc", className }: SVGProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={PIXEL_SIZE * 10}
    ...
    >
      <g fill={color}>
        <path d="M4 0h5v1H4zM3 1h1v2H3zM9 1h1v6H9z" />
        <path d="M1 2h5v1H1zM0 3h1v6H0zM6 3h1v6H6zM7 7h2v1H7zM1 9h5v1H1z" />
      </g>
    </svg>
  );
};

export const CopySmallSVG = ({ color = "#94b5bc", className }: SVGProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={PIXEL_SIZE * 5}
    ...
    >
      <g fill={color}>
        <path d="M2 0h3v1H2zM0 1h3v1H0zM4 1h1v3H4zM0 2h1v3H0zM2 2h1v3H2z" />
        <path d="M3 3h2v1H3zM1 4h2v1H1z" />
      </g>
    </svg>
  );
};

export const SunSVG = ({ color = "#94b5bc", className }: SVGProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={PIXEL_SIZE * 10}
    ...
    >
      <g fill={color}>
        <path d="M4 0h1v1H4zM1 1h1v1H1zM8 1h1v1H8zM4 2h2v6H4z" />
        <path d="M3 3h4v4H3z" />
        <path d="M2 4h6v2H2zM9 4h1v1H9zM0 5h1v1H0zM1 8h1v1H1zM8 8h1v1H8zM5 9h1v1H5z" />
      </g>
    </svg>
  );
};

export const MoonSVG = ({ color = "#94b5bc", className }: SVGProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={PIXEL_SIZE * 10}
